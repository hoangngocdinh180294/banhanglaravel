...
<head>
	...
	<title>Hoàng Ngọc Định||Trang chủ @yield('title')</title>
	<base href="{{ asset('') }}">
	...
	<link rel="stylesheet" href="page_asset/assets/dest/rs-plugin/css/settings.css">
	<link rel="stylesheet" href="page_asset/assets/dest/rs-plugin/css/responsive.css">
