                            ...
                            <li data-transition="boxfade" data-slotamount="20" class="active-revslide"
                                ...
                                <div class="slotholder" style="width:100%;height:100%;" data-duration="undefined"
                                    ...
                                    <div class="tp-bgimg defaultimg" data-lazyload="undefined" data-bgfit="cover"
                                         ...
                                         data-lazydone="undefined" src="page_asset/image/slide/{!! $item->image !!}"
                                         data-src="page_asset/image/slide/{!! $item->image !!}"
                                         style="background-color: rgba(0, 0, 0, 0); background-repeat: no-repeat; background-image: url('page_asset/image/slide/{!! $item->image !!}'); background-size: cover; background-position: center center; width: 100%; height: 100%; opacity: 1; visibility: inherit;">
                                    </div>
                                </div>
                            </li>
                        @endforeach
                                    ...
                                    <div class="col-sm-3">
                                        <div class="single-item">
                                            ...
                                            <div class="single-item-header">
                                                <a href="{!! route('chitietloaisanpham',['id'=>$item->id]) !!}"><img
                                                            src="page_asset/image/product/{!! $item->image !!}" alt=""
                                                            height="250px"></a>
                                            </div>
                                            ...
                                            <div class="single-item-caption">
                                                ...
                                                <a class="beta-btn primary" href="{!! route('list.shopping.cart') !!}">Giỏ
